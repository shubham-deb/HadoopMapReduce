...
// This class is used to initialize the thread using the runnable interface
...
//	It returns the common data structure that the threads wrote
	public HashMap<String,ArrayList<Integer>> getRecords(){
		return records;
	}

//	used to initialize the thread with a specific set of records
	public MyThread2(List<String> subList) {
		this.lines = subList;
	}
...
public class NoLock {
	...
	public static void main(String[] args) throws Exception {
		...
		for(int i=0;i<10;i++){
			MyThread2 th1 = new MyThread2(lines.subList(0, numOfLines));
			MyThread2 th2 = new MyThread2(lines.subList(numOfLines, lines.size()));
